...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE hbooking SET  pname='".$name."' ,email='".$email."'	,gender='".$gender."'	,mobileno='".$mobileno."',	arrived_date='".$arrived_date."',	depart_date='".$depart_date."',	total_person='".$total_person."',	room_type='".$room_type."',	addr='".$addr."'	,city='".$city."',	comment='".$comment."'	 WHERE id='".$setid."'";
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description"> Edit Booking </p>
